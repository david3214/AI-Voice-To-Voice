...
GPT_MODELS = {"3": "gpt-3.5-turbo", "4": "gpt-4"}
...
class OpenAIChatbot:
    def __init__(self, model=GPT_MODELS["3"]):
        ...
        self.messages.append(
            {
                "role": "system",
                "content": "You are a helpful chatbot, that will craft answers in a simple way to be understood in voice conversations. Keep your responses to one to two paragraphs",
            }
        )
